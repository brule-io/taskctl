...
%global upstream_version 0.2.0-alpha.2
...
Release:        %{?packaging_release}%{!?packaging_release:2}%{?dist}
Summary:        Repository task graphs and verified transitions
# No project license has been selected or granted. Replace with the settled
# SPDX expression and ship its text when the owner decides; preserve third-party notices.
License:        LicenseRef-taskctl-license-pending
...
The alpha protocol is not frozen; the project license decision remains pending.
...
%files
%license native/NOTICE.md native/THIRD-PARTY-NOTICES.zip
%doc support/README.rpm.md
%{_bindir}/taskctl
...
%changelog
* Sat Sep 05 2026 taskctl maintainers - 0.2.0~alpha.2-2
